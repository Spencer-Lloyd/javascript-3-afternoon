...
// evenNumbers = mixedNumbers.filter(num => num % 2 === 0)
evenNumbers = mixedNumbers.filter(function(i){
  return i % 2 === 0;
})
...
// postTaxPrices = prices.map(function(price){
//   return price *= 1.07;
// })
postTaxPrices = prices.map(price => price *= 1.07)
